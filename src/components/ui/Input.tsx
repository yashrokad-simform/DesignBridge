    ...
    <div className={cn('flex flex-col gap-1', className)}>
      ...
      >
        ...
        <input
          ...
          onChange={onChange}
          autoFocus={autoFocus}
          className="w-full bg-transparent border-none outline-none text-sm font-medium leading-snug text-input-text-enabled placeholder:text-input-text-placeholder disabled:text-input-text-disabled disabled:cursor-not-allowed"
        />
